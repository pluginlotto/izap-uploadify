...
<script type="text/javascript">
  jQuery(function () {
    ...
    jQuery('#<?php echo $vars['form_id']?>').uploadProgress({
      ...
      waitText : 'Uploading please wait',
      start: function() {
...
<div class="upload-progress" id="uploadProgress" style="display:none;">
  <div class="readout">
    <span class="mb_uploaded">0</span>/<span class="mb_total_size">0</span> MB - <span class="kb_average">0</span> kb/sec <br/><span class="time">0</span> <b>remaining</b>
  </div>
